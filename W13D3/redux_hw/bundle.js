...
function (_React$Component) {
  ...
  function Widget(props) {
    ...
    _this.forceUpdate = _this.forceUpdate.bind(_assertThisInitialized(_assertThisInitialized(_this))); // use a subscribe()
    ...
    value: function fetchJobListings(city) {
      $.ajax({
        ...
        success: function (resp) {
          ...
          // be dispatched
          this.props.store.dispatch(this.selectLocation(city, resp)); // use a dispatch
        }.bind(this)
      });
    }
  }, {
